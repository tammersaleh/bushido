...
* Outgoing email configuration (with "the SMTP TLS fix":http://github.com/ambethia/smtp-tls)
* User password reset functionality
* "Friendly Identifier":http://github.com/thoughtbot/friendly-identifier or slugalicious for slugs
* Protected assignment explosion
* "FakeWeb":http://github.com/chrisk/fakeweb/ for tests.
